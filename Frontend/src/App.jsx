...
import Header from "./Component/Header/Header"; // Updated path
import Footer from "./Component/Footer/Footer"; // Updated path
import About from "./Component/About/About";    // Updated path
import Home from "./Component/Home/Home";       // Updated path
