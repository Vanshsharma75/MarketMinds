...
import developerImage from '../../../../public/assets/webdev-png.png'; // Replace with your image path
import bugIcon from '../../../../public/assets/circle 1.png'; // Replace with your icon path
import developer from '../../../../public/assets/developer-img.png'; // Replace with your image path
import plan from '../../../../public/assets/plan.png';
import mordenTec from '../../../../public/assets/morden-tecnology.png';
import prototype from '../../../../public/assets/prototyping.png';
import development from '../../../../public/assets/development.png';
import coma from '../../../../public/assets/coma.png';
  ...
  return (
    ...
    <div className="Webbackimage">
      ...
      <div className="webdev-highlight-message">
        <h3 className='Web-headingh3'><img src={coma} className="coma" />About Website Design</h3>
